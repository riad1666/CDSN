          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex p-2 bg-white/5 rounded-[2rem] border border-white/5 overflow-x-auto no-scrollbar gap-2 flex-1">
              {[
                ...
                <button
                  ...
                  className={`flex items-center gap-3 px-8 py-4 rounded-[1.5rem] transition-all whitespace-nowrap relative ${activeTab === tab.id ? "bg-primary text-white shadow-xl shadow-primary/30" : "text-white/30 hover:text-white hover:bg-white/5"
                    }`}
                >
            ...
            {isAdmin && (
              ...
              >
                ...
                <span className="text-xs font-black uppercase tracking-widest">Add User</span>
              </button>
            )}
          </div>
                ...
                {members.map((member) => {
                  ...
                  return (
                    <div key={member.uid} className="glass-card rounded-[2.5rem] p-6 flex items-center justify-between group hover:border-primary/30 transition-all">
                      ...
                      <div className="flex items-center gap-3">
                        <div className={`px-4 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest ${mRole === 'owner' ? 'bg-warning/10 text-warning' : mRole === 'admin' ? 'bg-primary/10 text-primary' : 'bg-white/5 text-white/40'
                          }`}>
                          {mRole}
                        </div>
